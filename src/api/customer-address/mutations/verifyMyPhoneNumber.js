...
const schema = `
  verifyMyPhoneNumber(addressId: String!): Boolean
`;

const resolver = {
  verifyMyPhoneNumber: async (root, args, context) => {
    ...
    await new AddressEditor(context).verifyPhoneNumber(customerId, args.addressId);
    return true
  },
};
