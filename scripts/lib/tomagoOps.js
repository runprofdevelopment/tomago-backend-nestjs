...
const ADMIN_PATTERNS = [
  ...
  /^(transactionList|listTomagoAccount|viewTransactionById)$/i,
  ...
  /^(findTomagoAccount|accountAddFunds|accountDeductFunds)$/i,
  ...
  const rules =
    audience === 'Customer'
      ...
      : [
          ...
          { tag: 'Wallet & Finance', match: /^(wallet|voucher|withdrawal|transaction|tomago|accountAdd|accountDeduct|listTomago)/i },
